...
namespace CourseWork.SymmetricAlgorithms.BlockCipherMode
{
    public abstract class CipherTemplate
    {
        ...
        protected virtual List<Byte[]> ModifyOnFirstStageEncrypt(ref List<Byte[]> blocksList, ref Byte[] iv) { return new List<Byte[]>(); }
        protected virtual List<Byte[]> ModifyOnFirstStageDecrypt(ref List<Byte[]> blocksList, ref Byte[] iv) { return new List<Byte[]>(); }
    }
}