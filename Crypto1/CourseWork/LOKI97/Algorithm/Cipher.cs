...
namespace CourseWork.LOKI97.Algorithm
{
    public class Cipher
    {
        public static UInt64 Compute(UInt64 A, UInt64 B)
        {
            ...
            UInt64 e = P[S1[(int) ((d >> 56 | d << 8) & 0x1FFF)] & 0xFF] >> 7 |
            ...
            UInt64 f =
                    (ulong)((S2[(uint) (((e >> 56) & 0xFF) | ((B >> 53) & 0x700))] & 0xFFL) << 56 |
                            (S2[(uint) (((e >> 48) & 0xFF) | ((B >> 50) & 0x700))] & 0xFFL) << 48 |
                            (S1[(uint) (((e >> 40) & 0xFF) | ((B >> 45) & 0x1F00))] & 0xFFL) << 40 |
                            (S1[(uint) (((e >> 32) & 0xFF) | ((B >> 40) & 0x1F00))] & 0xFFL) << 32 |
                            (S2[(uint) (((e >> 24) & 0xFF) | ((B >> 37) & 0x700))] & 0xFFL) << 24 |
                            (S2[(uint) (((e >> 16) & 0xFF) | ((B >> 34) & 0x700))] & 0xFFL) << 16 |
                            (S1[(uint) (((e >> 8) & 0xFF) | ((B >> 29) & 0x1F00))] & 0xFFL) << 8 |
                            (S1[(uint) ((e & 0xFF) | ((B >> 24) & 0x1F00))] & 0xFFL));
